    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-1">
      {posts.map((post) => (
        <ClientRoute key={post._id} route={`/article/${post.slug.current}`}>
          <div className="max-w-[450px] bg-white flex justify-center flex-col items-center rounded overflow-hidden shadow-lg m-4 p-4 hover:bg-mywhite hover:scale-105 transition cursor-pointer">
            <Image
